...
// If you are comfortable enough with React, feel free to experiment with different folder structures. Anyways, let's look at the current structure that is created with create-react-app.
    // https://s3.amazonaws.com/General_V88/boomyeah2015/codingdojo/curriculum/content/chapter/react-project-structure.PNG


// The entry point in our React project is the src/index.js file. This file is where we call ReactDOM.render, and send in our main <App /> component (src/App.js). We will be rendering all of the content from our <App /> component in the div with id=root (in public/index.html) By importing the <App /> component, we can then put all of our React code within that component. That brings us over to src/App.js. This file will be where we can actually point the rest of our code towards. By default, it looks something like this:
